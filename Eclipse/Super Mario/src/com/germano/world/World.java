...
import com.germano.entities.Coin;
			...
			for (int xx = 0; xx < map.getWidth(); xx++) {
				for (int yy = 0; yy < map.getHeight(); yy++) {
					...
					if (pixelAtual == 0xFF000000) {
						...
						if (yy - 1 >= 0 && pixels[xx + (yy - 1) * map.getWidth()] == 0xFFFFFFFF) { // parede inteligente
						...
						// Moeda
						Coin coin = new Coin(xx * 16, yy * 16, 16, 16, 1, Entity.COIN_SPRITE);
