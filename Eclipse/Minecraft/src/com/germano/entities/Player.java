...
public class Player extends Entity {
	...
	public boolean attack = false, isAttacking = false;
	public int attackFrames = 0, maxFramesAttack = 10;

	public Player(int x, int y, int width, int height, double speed, BufferedImage sprite) {
		super(x, y, width, height, speed, sprite);
		ATTACK_RIGHT = Game.spritesheet.getSprite(96, 0, 16, 16);
		ATTACK_LEFT = Game.spritesheet.getSprite(112, 0, 16, 16);
	}
	...
	public void collisionEnemy() { // Dano dos inimigos
