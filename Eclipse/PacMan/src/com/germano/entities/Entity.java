...
public class Entity {
	...
	public static BufferedImage APPLE_SPRITE = Game.spritesheet.getSprite(0, 16, 16, 16);

	public static BufferedImage GHOST_SPRITE = Game.spritesheet.getSprite(16, 16, 16, 16);
	public static BufferedImage GHOSTMODE_SPRITE = Game.spritesheet.getSprite(32, 16, 16, 16);
